...
export const DATA = {
  name: "Vaibhav Tanwar",
  initials: "VT", 
  url: "https://www.linkedin.com/in/vaibhav-tanwar-profile/",
  ...
  summary:
    "I’m an aspiring machine learning engineer and researcher [currently working in the realm of Active Learning.](/work) I know a lot of passionate semicolons since 7th grade, and have fallen in love building software with the big toy (computer). Have built mobile apps and websites over the cloud that scaled over hundreds of users and for the ones I co-founded. I love contributing to open source software and also have my own OSS [projects](/#projects). Cracked the AWS Solutions Architect Associate cert in a month, won [three prizes at the first hackathon](https://parablerhythm.parameater.co/) I participated in (Generative A.I), built roblox games with over 500K player visits (guess that makes me an award winning game-dev too). Oh yes, I'm also a [computer science student.](/work#education)",
  avatarUrl:
    "/techie_emoji.png",
  skills: [ 
    "Typescript",
